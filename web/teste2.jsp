...
<html>
    ...
    <body>
        ...
        <%
           ...
           if (false) {
               meusItensProdutos = (ArrayList<ItemProduto>) request.getAttribute("meusItens");
            }
...
<section>
  ...
  if (faz){
         ...
         %>
				...
				<% int k = (aux.getValor())*(aux.getQuantidade() %>
                <td><%= NumberFormat.getCurrencyInstance().format(k)%></td> 
